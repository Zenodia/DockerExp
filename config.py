...
from examples.llama2_and_tools.tabular_llm import TabularLLM
...
def init_main_llm(config: RailsConfig):
    ...
    hf_token="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" # [TODO] to register this into the config.yaml as well
