...
class MTEncDecModel(EncDecNLPModel, Exportable):
    ...
    def __init__(self, cfg: MTEncDecModelConfig, trainer: Trainer = None):
        ...
        self.multilingual = cfg.get("multilingual", True)
        ...
        if cfg.encoder_tokenizer.get('tokenizer_model') is not None:
            ...
            print("cfg.encoder_tokenizer.get('tokenizer_model')=",cfg.encoder_tokenizer.get('tokenizer_model') )
        if cfg.decoder_tokenizer.get('tokenizer_model') is not None:
            ...
            print("cfg.decoder_tokenizer.get('tokenizer_model')=",cfg.decoder_tokenizer.get('tokenizer_model') )
        ...
        print("self.encoder_tokenizer=",self.encoder_tokenizer)
        if self.multilingual:
            (
                ...
                self.src_language, self.tgt_language, self.encoder_tokenizer,'sentencepiece'
            )
        else:
